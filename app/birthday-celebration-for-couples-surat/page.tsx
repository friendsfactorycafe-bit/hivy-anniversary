...
const keyword = service.keywords.find(k => k.slug === "birthday-celebration-for-couples-surat")!;

export const metadata: Metadata = {
  title: keyword.metaTitle,
  description: keyword.metaDescription,
  keywords: [keyword.title, "couples birthday", "birthday celebration", "Surat", "HIVY"],
