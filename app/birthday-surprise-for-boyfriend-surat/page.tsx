...
const keyword = service.keywords.find(k => k.slug === "birthday-surprise-for-boyfriend-surat")!;

export const metadata: Metadata = {
  title: keyword.metaTitle,
  description: keyword.metaDescription,
  keywords: [keyword.title, "birthday surprise", "boyfriend birthday", "Surat", "HIVY"],
