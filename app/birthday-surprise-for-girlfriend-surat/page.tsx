...
const keyword = service.keywords.find(k => k.slug === "birthday-surprise-for-girlfriend-surat")!;

export const metadata: Metadata = {
  title: keyword.metaTitle,
  description: keyword.metaDescription,
  keywords: [keyword.title, "birthday surprise", "girlfriend birthday", "Surat", "HIVY"],
