...
const keyword = service.keywords.find(k => k.slug === "candlelight-dinner-restaurants-surat")!;

export const metadata: Metadata = {
  title: keyword.metaTitle,
  description: keyword.metaDescription,
  keywords: [keyword.title, "candlelight restaurants", "romantic restaurants", "Surat", "HIVY"],
