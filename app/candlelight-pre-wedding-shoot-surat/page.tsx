...
const keyword = service.keywords.find(k => k.slug === "candlelight-pre-wedding-shoot-surat")!;

export const metadata: Metadata = {
  title: keyword.metaTitle,
  description: keyword.metaDescription,
  keywords: [keyword.title, "candlelight shoot", "romantic photography", "Surat", "HIVY"],
