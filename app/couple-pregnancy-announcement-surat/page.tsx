...
const keyword = service.keywords.find(k => k.slug === "couple-pregnancy-announcement-surat")!;

export const metadata: Metadata = {
  title: keyword.metaTitle,
  description: keyword.metaDescription,
  keywords: [keyword.title, "couple announcement", "pregnancy reveal", "Surat", "HIVY"],
